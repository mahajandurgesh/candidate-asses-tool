...
<%
	...
	PreparedStatement psmt = con.prepareStatement("select * from jobs where hid=?");
	psmt.setInt(1, Pojo.getHid());
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <%while(rs.next()){ %>
          <tr data-expanded="true">
            ...
            <td><a href="Short?&value=<%=rs.getInt(1)%>"><i class="fa-solid fa-trash-can"></i></a><br><br><a href="shortlisted.jsp?&value=<%=rs.getInt(1)%>"><i class="fa-solid fa-eye"></i></a></td>
          </tr>
          <%} %>
        </tbody>
      </table>
